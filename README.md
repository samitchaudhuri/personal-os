...
1. **Brain dump** - Drop notes into `Notes/Backlog.md` (no structure needed)
2. **Process** - Say "process my backlog" to your AI
3. **Get organized** - AI creates prioritized tasks based on `Notes/Goals.md`
...
## Directory Structure
This setup connects directly to an Obsidian vault, which serves as the source of knowledge. When a Cursor agent starts, it first reads AGENTS.md, a symlink to a file inside the vault. That file then directs the agent to vault/README.md, where it learns the vault’s folder structure, and working conventions.
...
**During work:** Brain dump into `Notes/Backlog.md`, save research to `References/`
